...
inherit autotools-utils bash-completion-r1 flag-o-matic linux-info python-r1 systemd toolchain-funcs udev eapi7-ver
...
if [ ${PV} == "9999" ] ; then
	...
	S="${WORKDIR}/zfs-${MY_PV2}"
	#SRC_URI="https://github.com/zfsonlinux/${PF}/releases/download/${P}/${P}.tar.gz"
	#KEYWORDS="~amd64"
fi
